        ...
        <div class="max-w-[1720px] w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            ...
            <div class="flex items-center justify-between h-16 sm:h-20 gap-3 sm:gap-6">
                ...
                <div class="relative hidden lg:block" @click.outside="categoryDropdownOpen = false">
                    ...
                    <!-- Clean 4-Column Mega Menu Dropdown -->
                    <div x-show="categoryDropdownOpen" x-cloak
                         x-transition:enter="transition ease-out duration-150"
                         x-transition:enter-start="opacity-0 scale-98"
                         x-transition:enter-end="opacity-100 scale-100"
                         class="absolute top-full left-0 mt-2 w-[980px] xl:w-[1060px] max-w-[calc(100vw-2rem)] bg-white rounded-3xl shadow-2xl border border-slate-100 p-6 z-50">
                        <div class="grid grid-cols-12 gap-5">
                            
                            <!-- Col 1: Hardware & PC Rakitan (3 cols) -->
                            <div class="col-span-3 border-r border-slate-100 pr-3">
                                <div class="text-[11px] font-black text-slate-400 uppercase tracking-wider mb-2.5 flex items-center gap-1.5">
                                    <span>🖥️ Hardware & PC</span>
                                </div>
                                <div class="space-y-1">
                                    <a href="{{ route('products.index', ['category' => 'laptop-gaming']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Laptop Gaming RTX
                                    </a>
                                    <a href="{{ route('products.index', ['category' => 'pc-komponen']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Komponen PC Rakitan
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'RTX 4080']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        VGA & Kartu Grafis
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Ryzen 7']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Processor AMD & Intel
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'RAM DDR5']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        RAM DDR5 & SSD NVMe
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Liquid Cooler']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Cooler & Liquid AIO
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Power Supply']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Power Supply 80+ Gold
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'PC Rakitan']) }}" class="block p-2 rounded-xl bg-emerald-50/70 border border-emerald-100 text-xs font-bold text-emerald-800 hover:bg-emerald-100/70 transition mt-2">
                                        ⚡ Simulasi Rakit PC Gratis
                                    </a>
                                </div>
                            </div>

                            <!-- Col 2: Peripheral & Esports (3 cols) -->
                            <div class="col-span-3 border-r border-slate-100 pr-3">
                                <div class="text-[11px] font-black text-slate-400 uppercase tracking-wider mb-2.5 flex items-center gap-1.5">
                                    <span>⌨️ Peripheral Esports</span>
                                </div>
                                <div class="space-y-1">
                                    <a href="{{ route('products.index', ['category' => 'keyboard-mechanical']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Keyboard Mechanical
                                    </a>
                                    <a href="{{ route('products.index', ['category' => 'mouse-gaming']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Mouse Gaming Ultralight
                                    </a>
                                    <a href="{{ route('products.index', ['category' => 'monitor-gaming']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Monitor 240Hz & OLED
                                    </a>
                                    <a href="{{ route('products.index', ['category' => 'audio-headset']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Headset 7.1 Spatial Audio
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Mousepad']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Mousepad Speed / Control
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Switch Keyboard']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Switch & Keycaps Custom
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'DAC Audio']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Soundcard & Gaming DAC
                                    </a>
                                </div>
                            </div>

                            <!-- Col 3: Konsol, Streamer & Room Setup (3 cols) -->
                            <div class="col-span-3 border-r border-slate-100 pr-3">
                                <div class="text-[11px] font-black text-slate-400 uppercase tracking-wider mb-2.5 flex items-center gap-1.5">
                                    <span>🎮 Konsol & Setup Room</span>
                                </div>
                                <div class="space-y-1">
                                    <a href="{{ route('products.index', ['category' => 'konsol-handheld']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        PlayStation 5 Slim & Pro
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Steam Deck']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Steam Deck & ROG Ally
                                    </a>
                                    <a href="{{ route('products.index', ['category' => 'streaming-gear']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Elgato & Streaming Deck
                                    </a>
                                    <a href="{{ route('products.index', ['category' => 'kursi-setup-meja']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Kursi Gaming Ergonomis
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Meja Elektrik']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Meja Elektrik Adjustable
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'RGB Lightbar']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Monitor Lightbar & RGB
                                    </a>
                                    <a href="{{ route('products.index', ['q' => 'Gamepad Wireless']) }}" class="block px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition">
                                        Gamepad & Controller
                                    </a>
                                </div>
                            </div>

                            <!-- Col 4: Layanan & Brand Partner (3 cols) -->
                            <div class="col-span-3 flex flex-col justify-between">
                                <div>
                                    <div class="text-[11px] font-black text-slate-400 uppercase tracking-wider mb-2.5">
                                        Brand Partner Resmi
                                    </div>
                                    <div class="grid grid-cols-2 gap-1.5 text-[10px] font-bold text-slate-600 mb-4">
                                        <span class="p-1.5 bg-slate-50 border border-slate-100 rounded-lg text-center">ASUS ROG</span>
                                        <span class="p-1.5 bg-slate-50 border border-slate-100 rounded-lg text-center">Razer</span>
                                        <span class="p-1.5 bg-slate-50 border border-slate-100 rounded-lg text-center">GeForce</span>
                                        <span class="p-1.5 bg-slate-50 border border-slate-100 rounded-lg text-center">PlayStation</span>
                                        <span class="p-1.5 bg-slate-50 border border-slate-100 rounded-lg text-center">Corsair</span>
                                        <span class="p-1.5 bg-slate-50 border border-slate-100 rounded-lg text-center">SteelSeries</span>
                                    </div>
                                </div>

                                <div class="p-3.5 bg-gradient-to-br from-emerald-600 to-teal-700 rounded-2xl text-white shadow-md">
